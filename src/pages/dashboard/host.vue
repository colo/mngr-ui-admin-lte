...
export default {
  ...
  **/
  ...
  stats_whitelist: /os_procs_stats|freemem|totalmem|cpus/,
  ...
  methods: {
    ...
    __init_charts: function(){
      ...
      **/
      ...
      // this.$set(this.available_charts[this.host+'.os_procs_stats_percentage_mem'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
      //   top: {
      //     count: 5,
      //     pids: []
      //   },
      ...
      **/
      ...
      // this.$set(this.available_charts[this.host+'.os_procs_stats_elapsed'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
      //   top: {
      //     count: 5,
      //     pids: []
      //   },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_stats_time'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          pids: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_cmd_stats_percentage_cpu'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          pids: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_cmd_stats_percentage_mem'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          cmds: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_cmd_stats_time'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          cmds: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_cmd_stats_count'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          cmds: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_uid_stats_percentage_cpu'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          pids: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_uid_stats_percentage_mem'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          uids: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_uid_stats_time'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          uids: []
        },
      ...
      **/
      ...
      this.$set(this.available_charts[this.host+'.os_procs_uid_stats_count'], 'chart', Object.merge(Object.clone(dygraph_line_chart),{
        top: {
          count: 5,
          uids: []
        },
